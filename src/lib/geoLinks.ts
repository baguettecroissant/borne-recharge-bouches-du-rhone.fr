/**
 * Geographic proximity linking engine for the Bouches-du-Rhône (13).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (43.30°N for Bouches-du-Rhône)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(43.30°) ≈ 80.9 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 80.9;
